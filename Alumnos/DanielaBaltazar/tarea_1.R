...
# porque el 70% de saber usar R es saber googlear ayuda
...
str(vector_2) #vemos que los elementos están entre comillas, pues ya son strings
...
mi_nombre <- paste(nombre, apellido, sep=" ")
...
matriz_1 <- matrix(sample(0:30, 60, replace= T), nrow=20, ncol=3) 
...
base_de_datos$variable_nueva <- c(T)
...
input <-"C:/Users/C Daniela Baltazar C/Documents/13/ICA/Clase1/IntroAR-master/datos"
tarea <- "C:/Users/C Daniela Baltazar C/Documents/13/ICA/Tareas"
...
write.csv(base_de_datos, paste(tarea, "mitarea.csv", sep="/"))
